...
class rankineController():
    def __init__(self, *args):
        ...
        """
        self.Model = rankineModel()  # Instantiate a rankineModel object
        self.View = rankineView()  # Instantiate a rankineView object
        self.IW = args[0]  # an array of widgets that are for user input
        self.DW = args[1]  # an array of widgets that are for display
        self.View.setWidgets(*args)  # call the setWidgets function of the view with self.IW and self.DW as arguments
