...
class MainWindow(qtw.QWidget, Ui_Form):
    def __init__(self):
        ...
        self.RC = rankineController(self.input_widgets,
                                    self.display_widgets)  # instantiate a rankineController object and pass as arguments the two lists of widgets to be unpacked into the View
    ...
    def SelectQualityOrTHigh(self):
        self.RC.selectQualityOrTHigh()  # call the selectQualityOrTHigh() method of the controller
    ...
    def SetUnits(self):
        ...
        self.RC.updateUnits(self.input_widgets, self.display_widgets, SI=SI)  # call the updateUnits() method of the
        # controller
